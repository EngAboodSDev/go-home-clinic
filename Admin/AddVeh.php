    ...
    <div class="page d-flex">
        <div class="sidebar bg-white p-20 p-relative">
            ...
            <ul>
                ...
                <li>
                    <a class="active d-flex align-center fs-14 c-black rad-6 p-10" href="AddVeh.php">
                        <i class="fa-solid fa-square-plus"></i>
                    ...
                    <div class="quick-draft p-20 bg-white rad-10">
                        ...
                        <form action="" class="doc_form" method="post">
                            <fieldset>
                                ...
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="v_name" required type="text" placeholder="Enter Vehicle Name">
                                ...
                                <div class="form-group">
                                    <input style="cursor: pointer; width: 20%; height: 35px;" class="save d-block fs-14 bg-blue c-white b-none w-fit btn-shape" type="submit" name="addVehicle" value="Add">
                                </div>
                            </fieldset>

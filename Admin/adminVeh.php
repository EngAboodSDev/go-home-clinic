...
<head>
    ...
    <title>Vehicles | GHC Admin Panel</title>
        ...
        <div class="content w-full">
            ...
            <div class="projects p-20 bg-white rad-10 m-20">
                <div style="display: flex; justify-content: space-between; align-items: center;" class="mb-20">
                    <h2 class="mt-0 mb-0"><i class="fa-solid fa-truck-medical c-blue"></i> Vehicles</h2>
                    <a href="AddVeh.php" style="padding: 10px 20px; text-decoration: none;"

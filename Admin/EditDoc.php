            ...
            <div class="content w-full form-cont">
                <div class="wrapper d-grid gap-20">
                    ...
                    <div class="quick-draft p-20 bg-white rad-10">
                        <h2 class="mt-0 mt-10"><i class="fa fa-edit c-blue"></i> Edit <?php echo $Doctor["f_name"]; ?>
                            Info.</h2>
                        <p class="mt-0 mb-20 c-grey fs-15"></p>
                        <form action="" class="doc_form" method="post">
                            <fieldset>
                                <label for=""> First Name*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="f_name" type="text"
                                    value="<?php echo $Doctor["f_name"]; ?>">

                                <label for="">Last Name</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="l_name" type="text"
                                    value="<?php echo $Doctor["l_name"]; ?>">

                                <label for="">Email*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="dr_email" required
                                    type="email" value="<?php echo $Doctor["dr_email"]; ?>">

                                <label for="">Password*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="dr_password"
                                    type="password" placeholder="Leave empty to keep current">
                                <label for="">Doctor PhoneNo*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="dr_phoneNo" required
                                    type="number" value="<?php echo $Doctor["dr_phoneNo"]; ?>">
                                <label for="">Doctor Location</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="dr_location" required
                                    type="text" value="<?php echo $Doctor["dr_location"]; ?>">
                            ...
                            <fieldset class="none">
                                ...
                                <select id="IsAvailable" name="IsAvailable"
                                    ...
                                    <option class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" value="1"
                                        <?php echo ($Doctor['IsAvailable'] == "1") ? "selected" : "" ?>>Available
                                    </option>
                                    <option class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" value="0"
                                        <?php echo ($Doctor['IsAvailable'] == "0") ? "selected" : "" ?>>Not Available
                                    </option>
                                </select>
                                ...
                                <select id="vehicles" name="vehicles"
                                    ...
                                    <option class="d-block mb-20 w-full p-10 b-none bg-eee rad-6"
                                        ...
                                        <?php echo ($vehicle["v_id"] == $Doctor["v_id"]) ? "selected" : "" ?>>

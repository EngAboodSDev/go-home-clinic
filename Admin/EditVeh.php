...
<head>
    ...
    <title>Edit Vehicle | GHC Admin Panel</title>
            ...
            <div class="content w-full form-cont">
                <div class="wrapper d-grid gap-20">
                    ...
                    <div class="quick-draft p-20 bg-white rad-10">
                        <h2 class="mt-0 mt-10"><i class="fa fa-edit c-blue"></i> Edit <?php echo $Vehicle["v_name"]; ?>
                            Info.</h2>
                        <p class="mt-0 mb-20 c-grey fs-15"></p>
                        <form action="" class="doc_form" method="post">
                            <fieldset>
                                <label for="">Vehicle Name*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="v_name" type="text"
                                    value="<?php echo $Vehicle["v_name"]; ?>">

                                <label for="">Car Plate*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="car_plate"
                                    type="text" value="<?php echo $Vehicle["car_plate"]; ?>">

                                <label for="location">Location*</label>
                                <input class="d-block mb-20 w-full p-10 b-none bg-eee rad-6" name="location" required
                                    type="text" value="<?php echo $Vehicle["location"]; ?>">

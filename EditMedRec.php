    ...
    <form action="#" method="post" class="app_form">
        <fieldset>
            ...
            <input type="text" id="pname" name="pname"
                value="<?php echo $patient['f_name'] . ' ' . $patient['l_name']; ?>" readonly><br><br>
            <label for="medRecDetails">Medical Record Details*:</label>
            <textarea name="medRecDetails" id="medRecDetails" cols="30"
                rows="10"><?php echo $medDetails['med_rec_details']; ?></textarea> <br><br>
        </fieldset>

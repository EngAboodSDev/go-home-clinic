        ...
        <div class="doc_sub_container">
            ...
            <div class="Doc_teams">
                ...
                <div class="btn-doctor">
                    <a class="ratte"
                        href="RateExperience.php?pId=<?php echo currentPatientId(); ?>&dId=<?php echo $myAppoint['dr_id'] ?>"
                        style="text-decoration: none;"><button class="btn-1">Rate</button></a>
                    <a href="RecordDetails.php?a=<?php echo $myAppoint['app_id'] ?>"
                        style="text-decoration: none;"><button class="btn-1 ">View Details</button></a>
                </div>
                <!-- <div class="btn-doctor">

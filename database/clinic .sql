...
(2, 'Dr.Sara', 'Ali', 'SaraAli@gmail.com', '312dc6ec7c900fb9017bf43c6b1f81bb', 1, 'General Pysician', 'A general practitioner treats a commoon medical phd conditions and perform routine exams, got an ABIM, AOBFP, and ACP.', 'fdsasdas', 85755255, 2, 1),
...
--
ALTER TABLE `appointment`
  MODIFY `app_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
